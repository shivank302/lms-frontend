...
export default function CourseDetail() {
  ...
  return (
    <div className="p-6 text-white bg-gray-900 min-h-screen">
      ...
      <button onClick={updateProgress} className="ml-2 px-3 py-1 bg-blue-500 rounded">
        Update
      </button>
      ...
      <div className="mt-6">
        ...
        <input onChange={(e) => setAnswer(e.target.value)} className="p-2 text-black" />

        <button onClick={checkAnswer} className="ml-2 px-3 py-1 bg-purple-500 rounded">
          Submit
        </button>
      </div>
    </div>
